...
declare namespace p5 {
  ...
  interface Element {
    ...
    // TODO: Fix position() errors in src/dom/dom.js, line 1755:
    //
...
declare namespace p5 {
  interface p5InstanceExtensions {
     ...
     *   tombstone or exhibit label/caption in a  adjacent
     *   to the canvas. You can style it as you wish in
     *   your CSS.
     *
     *
     *
    ...
    describeElement(
      name: string,
      text: string,
      display?: DESCRIBE_DISPLAY
    ): void;
  }
}

// p5.ACCESSIBILITY.OUTPUTS
declare namespace p5 {
  interface p5InstanceExtensions {
    /**
...
declare namespace p5 {
  interface p5InstanceExtensions {
     ...
     *   correctly if you view the sketch using sketch the
     ...
     *   sketch using sketch the edtior's present or share
     *   URLs.
...
declare namespace p5 {
  interface p5InstanceExtensions {
    ...
    storeItem(
      key: string,
      value: string | number | object | boolean | Color | Vector
    ): void;
